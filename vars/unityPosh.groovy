// Takes care of executing powershell scripts linked to Unity.
...
def activateLicense( String serial, String project_folder, String base_arguments )
{
   withCredentials( [
...
{
   powershell(
          label: "Deactivate Unity License",
          returnStdout: false,
